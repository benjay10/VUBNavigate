...
var dpi=this.pendingDialogStack[0];var dialog=dpi.dialog;var position=dialog.compareDocumentPosition(event.target);if(position&Node.DOCUMENT_POSITION_PRECEDING){if(this.forwardTab_){dpi.focus_()}else if(event.target!==document.documentElement){document.documentElement.focus()}}else{}
